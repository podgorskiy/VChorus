...
def main():
  ...
  plistpath = scriptpath + "/resources/VChorus-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VChorus-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VChorus-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VChorus-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VChorus-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/VChorus.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/VChorus.iss",inplace=1):
