...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=VChorus Demo Installer\n"
      else:
        line="OutputBaseFilename=VChorus Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the VChorus Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the VChorus installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=VChorus Demo installer\n"
     else:
       line="SetupWindowTitle=VChorus installer\n"
