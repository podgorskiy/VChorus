...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Reverb Demo Installer\n"
      else:
        line="OutputBaseFilename=Reverb Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Reverb Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Reverb installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Reverb Demo installer\n"
     else:
       line="SetupWindowTitle=Reverb installer\n"
